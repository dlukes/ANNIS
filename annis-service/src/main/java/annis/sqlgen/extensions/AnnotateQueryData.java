...
public class AnnotateQueryData {
	...
	private List<String> filterNodeAnnos;
	...
	public List<String> getFilterNodeAnnos() {
		return filterNodeAnnos;
	}

	public void setFilterNodeAnnos(List<String> filterNodeAnnos) {
		this.filterNodeAnnos = filterNodeAnnos;
	}
